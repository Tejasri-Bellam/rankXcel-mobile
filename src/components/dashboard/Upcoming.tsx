...
const mocks = dashboardData.upcomingMocks;
    ...
    >
      ...
      {mocks.map((item, index) => (
        ...
        >
          ...
          >
            <Text style={styles.mockName}>
              {item.name}
            </Text>

            <Text style={styles.mockWhen}>
              {item.when}
            </Text>
          </View>
...
const styles: any = {
    ...
    // Upcoming Mocks
        ...
        mockRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 12, borderTopWidth: 1, borderTopColor: COLORS.border },
