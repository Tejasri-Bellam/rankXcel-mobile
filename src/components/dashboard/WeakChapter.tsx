...
const chapters = dashboardData.weakChapters;
...
export default function WeakChapter() {
  return (
    ...
    <View style={styles.card}>
          ...
          {chapters.map((item, index) => (
            <View
              key={index}
              style={styles.weakChapterRow}
            >
              <View
                style={[
                  styles.weakRankBubble,
                  {
                    backgroundColor:
                      item.color,
                  },
              ...
              >
                <Text style={styles.weakRankText}>
                  {item.rank}
                </Text>
              </View>
              ...
              >
                <View style={styles.weakNameRow}>
                  <Text style={styles.weakChapterName}>
                    {item.name}
                  </Text>
...
const styles: any = {
  ...
  weakChapterRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 14 },
  weakRankBubble: { width: 28, height: 28, borderRadius: 14, alignItems: 'center', justifyContent: 'center' },
  weakRankText: { color: COLORS.white, fontWeight: '700', fontSize: 13 },
  weakNameRow: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 6 },
  weakChapterName: { fontSize: 14, fontWeight: '600', color: COLORS.textDark, flex: 1 },
  ...
  viewAllBtn: { alignItems: 'center', marginTop: 4, paddingVertical: 10, borderTopWidth: 1, borderTopColor: COLORS.border },
