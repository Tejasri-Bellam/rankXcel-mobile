...
const OnboardingFlow = () => {
    ...
    return (
        ...
        <ScrollView contentContainerStyle={s.completeContent}>
            ...
            {data.complete.subtitle}
            </Text>

            <View style={s.summaryCard}>
            <Text style={s.summaryHeading}>
                {data.complete.heading}
            </Text>
            ...
            <View style={s.summaryRow}>
                ...
                <Text style={s.summaryValue}>
                    {priorityFocusSubject?.name ||
                    data.complete.noPriority}
                </Text>
                </View>
            </View>
            ...
            >
                ...
                <View>
                <Text style={s.summaryLabel}>
                    {data.complete.dailyLabel}
                </Text>

                <Text style={s.summaryValue}>
                    {data.complete.dailyValue(
                    dailyHours
                    )}
                </Text>
                </View>
...
if (step === 1) {
  const canSubmit =
    Boolean(selectedExam && targetYear) &&
    !submittingGoal;
      ...
      >
        ...
        <View style={s.body}>
          ...
          <View style={s.inputGroup}>
            <Text style={s.label}>
              {data.goal.labels.exam}
            </Text>

            <TouchableOpacity
              style={s.dropdown}
              onPress={() =>
                setExamDropdownOpen((v) => !v)
              }
              activeOpacity={0.8}
            >
              <Ionicons
        ...
        >
            ...
            <View style={s.sliderBlock}>
                ...
                <Text style={s.sliderValue}>
                    {data.assessment.dailyHoursValue(
                    dailyHours
                    )}
                </Text>
                </View>
  ...
  <View style={s.safeArea}>
    ...
    >
      ...
      <View style={s.body}>
          ...
          <View style={s.diagnosticHeader}>
            ...
            <View style={{ flex: 1 }}>
              <Text style={s.diagnosticTitle}>
                {data.diagnostic.cardTitle(
                  selectedExam?.name || 'Exam'
                )}
              </Text>

              <Text style={s.diagnosticDesc}>
                {data.diagnostic.cardDesc}
              </Text>
            </View>
          </View>
          ...
          <View style={s.diagnosticHighlight}>
            ...
            <View style={{ flex: 1 }}>
              <Text style={s.diagnosticHighlightTitle}>
                {data.diagnostic.highlightTitle(
                  subjects.length
                )}
              </Text>

              <Text style={s.diagnosticHighlightDesc}>
                {data.diagnostic.highlightDesc(
        ...
        <Text style={s.whatYouGetTitle}>
          {data.diagnostic.whatYouGet}
        </Text>
