...
export const mockSolutionStyles = StyleSheet.create({
  ...
  pillsScroll: { borderBottomWidth: 1, borderBottomColor: BORDER, flexGrow: 0 },
  pillsRow: { flexDirection: 'row', paddingHorizontal: 14, paddingVertical: 10, gap: 8 },
  pill: {
    width: 32, height: 32, borderRadius: 8, borderWidth: 1.5, borderColor: BORDER,
  ...
  markBadgeGreen: { backgroundColor: '#F0FDF4', paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 },
  markBadgeRed: { backgroundColor: '#FEF2F2', paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 },
  ...
  bubbleCorrect: { borderColor: '#22C55E', backgroundColor: '#22C55E' },
  bubbleWrong: { borderColor: '#EF4444', backgroundColor: '#EF4444' },
  ...
  stepsChip: { backgroundColor: ACCENT, paddingHorizontal: 8, paddingVertical: 2, borderRadius: 10 },
